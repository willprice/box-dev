...
If (-Not (Test-Path "HKLM:\SYSTEM\CurrentControlSet\Control\TimeZoneInformation")) {
    New-Item -Path "HKLM:\SYSTEM\CurrentControlSet\Control\TimeZoneInformation" | Out-Null
}
Set-ItemProperty -Path HKLM:\SYSTEM\CurrentControlSet\Control\TimeZoneInformation -Name RealTimeIsUniversal -Type QWord -Value 1
